...
CONFIG.WUSER_WIDTH {0} \
  ...
  set_property -dict [ list \
CONFIG.ASSOCIATED_BUSIF {S_AXI_MEMCNT} \
 ] $PL_CLK
...
preplace port PL_CLK -pg 1 -y 200 -defaultsOSRD
preplace port S_AXI_MEMCNT -pg 1 -y 70 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 80 -defaultsOSRD
preplace portBus PL_RSTN -pg 1 -y 410 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -y 370 -defaultsOSRD
...
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 2 350 280 790
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 0 3 40 460 NJ 460 800
preplace netloc S_AXI_MEMCNT_1 1 0 1 N
preplace netloc processing_system7_0_FIXED_IO 1 2 1 NJ
preplace netloc axi_interconnect_0_M00_AXI 1 1 1 N
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 30 250 340 270 810
preplace netloc proc_sys_reset_0_interconnect_aresetn1 1 0 3 20 10 NJ 10 800
levelinfo -pg 1 0 190 570 830 -top 0 -bot 470
",
}
